...
export const eventExamples = [
  new TR_Event(201, "Music Fest", "Live music festival", "123-456-7890", accountExamples[0].username, [imageExamples[6], imageExamples[18]], "18:00:00", "23:00:00", "2024-01-15", "2025-12-31", "New York", "123 Broadway", [true, true, true, true, true, false, false], "Concert"),
  ...
  new TR_Event(209, "Main Event", "Grand event with all attractions", "777-888-9999", accountExamples[3].username, [imageExamples[12], imageExamples[6]], "12:00:00", "22:00:00", "2024-09-15", "2025-12-31", "Houston", "500 Main St", [true, true, true, true, false, false, true], "Event"),
  ...
  new TR_Event(301, "Tel Aviv Museum of Art", "Premier modern and contemporary art museum", "123-987-6543", accountExamples[0].username, [imageExamples[10]], "09:00:00", "18:00:00", "2025-01-01", "2025-12-31", "Tel Aviv", "27 Shaul Hamelech Blvd", [true, true, true, false, true, false, false], "Tel Aviv Museum"),
  new TR_Event(302, "Eretz Israel Museum", "Museum dedicated to archaeology and ethnography", "098-123-4567", accountExamples[1].username, [imageExamples[11]], "09:00:00", "18:00:00", "2025-01-01", "2025-12-31", "Tel Aviv", "2 Haim Levanon St", [true, true, true, true, true, false, true], "Eretz Israel Museum"),
  new TR_Event(303, "Neve Tzedek", "Historic neighborhood with charming streets, shops, and galleries", "555-987-6543", accountExamples[2].username, [imageExamples[12]], "10:00:00", "20:00:00", "2025-01-01", "2025-12-31", "Tel Aviv", "Neve Tzedek", [true, true, false, true, false, false, true], "Cultural District"),
  new TR_Event(304, "Carmel Market (Shuk HaCarmel)", "Vibrant marketplace with fresh produce, spices, and delicacies", "333-444-5555", accountExamples[3].username, [imageExamples[14], imageExamples[19]], "08:00:00", "18:00:00", "2025-01-01", "2025-12-31", "Tel Aviv", "Carmel St", [true, true, false, true, true, false, false], "Market"),
  new TR_Event(305, "Tel Aviv Port Area (Namal Tel Aviv)", "Revitalized waterfront area with shops, restaurants, and cultural venues", "666-777-8888", accountExamples[4].username, [imageExamples[14]], "09:00:00", "23:00:00", "2025-01-01", "2025-12-31", "Tel Aviv", "Hamered St", [true, true, true, true, true, false, true], "Cultural Hub"),
  new TR_Event(306, "Taizu Restaurant", "Asian fusion cuisine with Southeast Asian street food-inspired dishes", "444-555-6666", accountExamples[0].username, [imageExamples[16]], "12:00:00", "23:00:00", "2025-01-01", "2025-12-31", "Tel Aviv", "Rothschild Blvd", [true, true, false, false, true, false, true], "Taizu Restaurant"),
  new TR_Event(307, "Shila Restaurant", "Fresh seafood and grilled dishes", "777-888-9999", accountExamples[1].username, [imageExamples[17]], "12:00:00", "23:00:00", "2025-01-01", "2025-12-31", "Tel Aviv", "Ben Yehuda St", [true, true, true, false, true, false, true], "Shila Restaurant"),
  new TR_Event(308, "White Night (Laila Lavan)", "Citywide celebration with free events, concerts, and performances", "888-999-0000", accountExamples[2].username, [imageExamples[17]], "18:00:00", "06:00:00", "2025-06-15", "2025-06-15", "Tel Aviv", "Various locations", [true, true, false, true, true, true, false], "White Night Festival"),
  new TR_Event(309, "Israel Festival", "Multi-disciplinary arts festival featuring theater, dance, and music", "555-666-7777", accountExamples[3].username, [imageExamples[18]], "10:00:00", "22:00:00", "2025-05-01", "2025-05-10", "Jerusalem", "Various venues", [true, false, true, true, false, false, true], "Music Festival"),
